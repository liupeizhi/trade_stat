...
public final class ExcelUtil {
     ...
     */
//    public static <T> List<T> readExcel(final InputStream inputStream, final Class<? extends BaseRowModel> clazz) {
//        if (null == inputStream) {
...
//
//        Sheet sheet = new Sheet(0,1, GuoXinExcelTemplate.class);
