...
public class DateUtils {
     ...
     */
    public static final String DATE_TIME_FORMAT_YYYYMMDDHHMISS = "yyyyMMdd-HH:mm:ss";
    ...
    public static final String DATE_TIME_FORMAT_YYYYMMDDHHMI = "yyyyMMddHHmmss";
    ...
    public static String nextDay(String day){
        Date date = parseStrToDate(day,DATE_FORMAT_YYYY_MM_DD);
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        calendar.add(Calendar.DATE, +1);
        date = calendar.getTime();
        return parseDateToStr(date,DATE_FORMAT_YYYY_MM_DD);
    }
    ...
    public static List<String> getDays(String start, String end) {
        ...
        Date localDateStart = DateUtils.parseStrToDate(start, DateUtils.DATE_FORMAT_YYYY_MM_DD);
        Date localDateEnd = DateUtils.parseStrToDate(end, DateUtils.DATE_FORMAT_YYYY_MM_DD);

        Long oneDay = 1000 * 60 * 60 * 24l;
        long time = localDateStart.getTime();
        long endTime = localDateEnd.getTime();

        while (time <= endTime) {
            Date d = new Date(time);
            days.add(DateUtils.parseDateToStr(d, DateUtils.DATE_FORMAT_YYYY_MM_DD));
            time += oneDay;
     ...
     * @return 相差天数
     */
    public static int getDistanceDays(Date first, Date last) {
